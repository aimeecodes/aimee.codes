...
<pre>MSZoning: Identifies the general zoning classification of the sale.
       ...
       RM	Residential Medium Density </pre>
...
<pre>>>> test_data[test_data['MSZoning'].isna()][['Id', 'MSZoning', 'Neighborhood', 'MSSubClass', 'Utilities', 'LotConfig']] 
...
<pre>>>> train_data['MSZoning'].value_counts()
RL         1151
RM          218
FV           65
RH           16
...
<pre>>>> test_data['MSZoning'].value_counts()
RL         1114
RM          242
FV           74
C (all)      15
...
<pre>>>> test_data.at[455, 'MSZoning'] = 'RM'
>>> test_data.at[756, 'MSZoning'] = 'RM'
>>> test_data.at[790, 'MSZoning'] = 'RM'
>>> test_data.at[1444, 'MSZoning'] = 'RL'</pre>
...
<pre># initialize the Series as a DataFrame column
...
Veenker           238772.73   72369.32</pre>
...
<pre>>>> grouped['SalePrice'].mode()
AttributeError: 'SeriesGroupBy' object has no attribute 'mode'</pre>
...
<pre>>>> merge_data.groupby('Neighborhood')['MSZoning'].agg(pd.Series.mode)
Neighborhood
Blmngtn    RL
Blueste    RM
BrDale     RM
...
<pre># check to make sure no more NAs exist for this variable
